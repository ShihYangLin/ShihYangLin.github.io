export const strings = {
  en: {
    ...
    backToTopics: 'All topics', feedback: 'Feedback', reportProblem: 'Report this problem',
    ...
    siteControls: 'Site controls', languageControls: 'Language', englishButton: 'Switch to English', chineseButton: 'Switch to Traditional Chinese',
  ...
  zh: {
    ...
    backToTopics: '所有主題', feedback: '意見回饋', reportProblem: '回報這題',
    progressTitle: '學習進度', progressIntro: '進度儲存在此瀏覽器。某題型最高級別連續三次首次作答正確，即標記為精熟。',
    siteControls: '網站操作', languageControls: '語言', englishButton: '切換為英文', chineseButton: '切換為繁體中文',
