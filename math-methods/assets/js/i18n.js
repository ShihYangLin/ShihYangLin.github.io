export const strings = {
  en: {
    ...
    themeToDark: 'Switch to dark theme', themeToLight: 'Switch to light theme', siteControls: 'Site controls', languageControls: 'Language', englishButton: 'Switch to English', chineseButton: 'Switch to Traditional Chinese',
